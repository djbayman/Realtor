  ...
  return (
    <div className="my-20 grid grid-cols-6 gap-10">
      <div className="col-span-6 md:col-span-4 md:col-start-2 box  md:flex gap-6">
        ...
        <div className="info ">
          <span className=" text-gray-500 capitalize">Rent a Home</span>
          <h2 className="text-2xl font-bold capitalize my-4 max-w-56">
          ...
          <Link to={"/search/purpose=for-rent"}>
            <button
              className="py-2 px-3 bg-blue-100 font-semibold text-lg rounded-md hover:bg-blue-200"
              onClick={() =>
